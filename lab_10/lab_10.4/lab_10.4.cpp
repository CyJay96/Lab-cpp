...
Создать шаблон класса «односвязный список указателей с правом владения» (воспользовавшись шаблоном из задания 8.4).
Использовать его для создания контейнера потомков-объектов, описанных в 10.1. Для данного списка реализовать следующие методы:
• инициализация списка;
• добавление объекта в список;
• исключение элемента (с удалением объекта, на который он ссылается);
• просмотр элементов списка и вывод на экран элементов списка с соответствующими полями для каждого объекта;
• удаление всех элементов, хранящихся в списке (с удалением объектов);
• создание копии списка (с копиями объектов).
...
Для сред разработки, поддерживающих стандарт С++11 и выше, определить конструктор перемещения и оператор перемещения списка.
